...
public partial class InitialPostgreSqlCreate : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 1, "Keine Auffälligkeiten festgestellt.", new DateTime(2026, 5, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Anna Müller", "Hydraulikpumpe HP-200", "Bestanden" },
                { 2, "Gehäuse leicht beschädigt, Funktion gegeben.", new DateTime(2026, 5, 3, 0, 0, 0, 0, DateTimeKind.Utc), "Max Schneider", "Steuergerät SG-42", "Mängel" }
            });
    }
